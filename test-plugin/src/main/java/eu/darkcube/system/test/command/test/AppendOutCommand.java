...
public class AppendOutCommand extends BaseCommand {
    public AppendOutCommand() {
        super("appendOutputStream", b -> b.then(Commands.argument("text", StringArgumentType.greedyString()).executes(ctx -> {
            ...
            storage.appendOutputStreamAsync(ServiceTemplate.builder().storage("woolbattle").prefix("test").name("default").build(), "test.txt").whenComplete((out, throwable) -> {
