...
public record FoodMapper() implements Mapper<Food, FoodProperties> {
    ...
    public FoodProperties apply(Food mapping) {
        return new FoodProperties(mapping.nutrition(), mapping.saturationModifier(), mapping.canAlwaysEat());
    ...
    public Food load(FoodProperties mapping) {
        return new Food(mapping.nutrition(), mapping.saturation(), mapping.canAlwaysEat());
