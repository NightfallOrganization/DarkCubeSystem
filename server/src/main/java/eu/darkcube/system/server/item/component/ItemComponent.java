...
public interface ItemComponent {
    ...
    DataComponent<Consumable> CONSUMABLE = register("consumable");
    ...
    DataComponent<DamageResistant> DAMAGE_RESISTANT = register("damage_resistant");
    DataComponent<DeathProtection> DEATH_PROTECTION = register("death_protection");
    ...
    DataComponent<Integer> ENCHANTABLE = register("enchantable");
    ...
    DataComponent<Equippable> EQUIPPABLE = register("equippable");
    ...
    DataComponent<Unit> GLIDER = register("glider");
    ...
    DataComponent<Key> ITEM_MODEL = register("item_model");
    ...
    DataComponent<CompoundBinaryTag> LOCK = register("lock");
    ...
    DataComponent<ObjectSet> REPAIRABLE = register("repairable");
    ...
    DataComponent<Key> TOOLTIP_STYLE = register("tooltip_style");
    DataComponent<ArmorTrim> TRIM = register("trim");
    DataComponent<Unbreakable> UNBREAKABLE = register("unbreakable");
    DataComponent<UseCooldown> USE_COOLDOWN = register("use_cooldown");
    DataComponent<ItemBuilder> USE_REMAINDER = register("use_remainder");
